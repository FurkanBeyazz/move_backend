        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoveRelaseDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IMDb = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MoveCategoriesID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_movies", x => x.MoveID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MoviesCategoriesID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MoviesCategoriesName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_moviesCategories", x => x.MoviesCategoriesID);
                });

            migrationBuilder.CreateTable(
                name: "moviesFavoriteMove",
                columns: table => new
                {
                    MoveFovorite_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_moviesFavoriteMove", x => x.MoveFovorite_ID);
                });
